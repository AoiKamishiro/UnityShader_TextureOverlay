...
namespace AKSTextureOverlay {
    public class AKSTextureOverlay6GUI : ShaderGUI {
        ...
        private void FindProperties (MaterialProperty[] props) {
            ...
            color5 = FindProperty ("_Color5", props);
            color6 = FindProperty ("_Color6", props);
        ...
        private void ShaderPropertiesGUI (Material material) {
            EditorGUI.BeginChangeCheck (); {
                ...
                m_MaterialEditor.TexturePropertyWithHDRColor (new GUIContent (tex5.displayName), tex5, color5, true);
                m_MaterialEditor.TexturePropertyWithHDRColor (new GUIContent (tex6.displayName), tex6, color6, true);
                EditorGUILayout.Space ();
            ...
            AKSUIHelper.ShurikenHeader (AKSStyles.nameAKTextureOverlay6);
